# Soroban Render Documentation

Welcome to the Soroban Render documentation. This guide will help you understand and use Soroban Render to build self-contained dApps on Stellar's Soroban platform.

## Quick Navigation

### Getting Started

- [Introduction](./introduction.md) - What is Soroban Render and why use it?
- [Getting Started](./getting-started.md) - Set up your first renderable contract
...
**New to Soroban Render?** Start here:

1. Read the [Introduction](./introduction.md) to understand the concept
2. See [Viewing Contracts](./viewing-contracts.md) to understand how easy viewing is
3. Follow the [Hello World Comparison](./hello-world.md) to see the full simplicity
4. Work through the [Getting Started](./getting-started.md) guide
